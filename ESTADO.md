...
| Contas | 2 |
| Rotas Flask | 84 |
| Tabelas em `radar.db` | 12, as da plataforma. As 13 da empresa estão em `empresas/1/empresa.db` desde 23/09 (F1) |
| Índices em `anuncios` | 14, dos quais dois novos a 17/09 para o filtro por entidade (+22 MB) |
| Testes | **1 103**, em ~67 s, sem rede e sem tocar na base verdadeira |
