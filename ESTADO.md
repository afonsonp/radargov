...
| Testes | **1 421**, em ~150 s, sem rede e sem tocar em nenhuma das duas bases verdadeiras (o corpus só desde 26/09) |
| Código | `radar.py` 30 557 linhas · `teste_radar.py` 20 161 · `empresa.py` 865 · `contas.py` 722 · `icones.py` 62 |
