# Referência: como cada parte foi feita

As secções do antigo `ESTADO.md` que não têm data: descrevem
**como** cada parte da aplicação funciona e porque foi feita
assim. Saíram para aqui a 3/09/2026, sem uma palavra mudada.
