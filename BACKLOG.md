...
| 2R-§7 | **O resto da página do dono** (a §7 da síntese da segunda ronda, pela ordem dela; a 26/09/2026 fizeram-se a conta do dono, a página de cada empresa, os convites anulados e gerados de novo, o «ver como a empresa, só leitura», os semáforos e o «a tratar hoje», o correio da plataforma com o e-mail de teste, recusar pedidos, suspender empresas e a F2) | Por esta ordem: **(1)** o 2.º factor da conta do dono (D16); **(2)** a honestidade do correio fora da plataforma — o «mandei» dos alertas só quando mandou (E5) e a faixa nos alertas quando o e-mail não sai (E6); **(3)** o emblema com os pedidos por decidir na barra; **(7)** a lista dos erros (data, rota, tipo, empresa, utilizador), com o texto inteiro e «dar por visto» — hoje o semáforo conta e leva aos Indicadores, que mostram só o último de cada tipo; **(8)** tirar ou suspender **uma conta** pelo dono, registado como «pelo suporte» (a empresa inteira já se suspende); **(10)** o passo opcional do perfil depois de aceitar e o molde da plataforma nos pedidos (a lista já tem migalhas e cartões no telemóvel); **(11)** o registo de actividade — entradas (e as falhadas, com IP e aparelho), mudanças de configuração, triagens —, visível ao admin e ao dono; **(12)** o registo dos envios dos alertas, e na ficha «porque é que este não avisou»; **(13)** um tecto **mensal** de leituras por empresa (hoje o tecto é por dia; a página mostra o mês ao lado); **(14)** criar a empresa pela interface, sem pedido do site (o convite para uma empresa que já existe já se cria na página dela); **(15)** exportar os dados de uma empresa (RGPD), primeiro pela consola; **(16)** a nota interna por empresa, só do dono. E fechar **uma** sessão da conta (hoje é «sair de todos»). Os «Depois» da §7 (aviso a todos os clientes, plano e fim do teste, resumo diário ao dono, risco de abandono) ficam para quando houver 5 ou mais clientes | **Uma sessão por grupo**; o (1) e o (11) são os que mais pesam na segurança |
